...
from audio_capture2 import AudioCapture
from transcription2 import RealTimeTranscription
from summarization2 import Summarization
...
class FloatingWindow:
    def __init__(self):
        ...
        img = tk.PhotoImage(file="our_logo.png")
